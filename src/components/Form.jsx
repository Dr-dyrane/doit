    ...
    return (
      <form onSubmit={this.handleSubmit} className="w-full">
        <div className="flex items-center justify-between">
          ...
          <button
            type="submit"
            className="bg-transparent inline-flex border border-purple-500 text-purple-500 px-4 py-2.5 rounded-r-lg hover:bg-purple-500 hover:text-white transition-colors duration-300"
          >
            Add
          </button>
        </div>
